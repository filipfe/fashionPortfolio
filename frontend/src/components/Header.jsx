...
export default function Header() {
    ...
    return (
        <header className={`flex justify-between items-center min-h-[5rem] lg:min-h-[6rem] bg-white padding-x shadow-sm fixed top-0 right-0 left-0 ${location.pathname.includes("login") || url === "signup" || url === "contact" || url === "recovery" ? 'hidden' : 'z-20'}`}>
