    ...
    return (
        <div className="cart flex flex-col lg:max-w-[max-content]">
            ...
            <div className="summary grid grid-cols-2 grid-rows-2 border-[#BDBDBD] border-t-2">
                ...
                <a className="row-span col-second self-center ml-auto bg-darkPrimary text-white text-lg font-bold max-w-[max-content] py-2 px-6" path='/profile/buy'>Proceed payment</a>
