    ...
    return (
        <section className="landing relative min-h-screen padding-y padding-x lg:grid lg:gap-4 lg:grid-cols-2 bg-[linear-gradient(180deg, rgba(53, 82, 220, 0.0043) -4.68%, rgba(53, 82, 220, 0.0258) 102.57%)]">
            <div className='min-h-full flex flex-col gap-8 lg:mt-[5vh] lg:gap-2'>
                ...
                <p className='font-medium text-[#707070] lg:max-w-[90%] lg:my-8 lg:text-xl'>Wear newest clothes and become friends with fashion</p>
                <Link to='/clothing' className="bg-primary rounded-md transition-colors hover:bg-darkPrimary text-white lg:text-md py-3 px-10 font-medium mt-4 flex items-center relative max-w-[max-content]">Explore offers <img className='max-h-[.8em] ml-[1.2em]' src={arrow} alt='' /></Link>
            </div>
            <img className='main-image lg:left-auto mt-24 lg:mt-[5vh] absolute lg:w-[48vw] right-0 self-center' src={main} alt="clothing" />
